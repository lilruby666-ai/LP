...
const imageUrls = [
    "https://i.imgur.com/PDOXmy0.jpeg",
    ...
    "https://picsum.photos/200/300?cityscape",
    "https://picsum.photos/200/300?architecture",
    "https://picsum.photos/200/300?street",
    "https://picsum.photos/200/300?lights",
    "https://picsum.photos/200/300?downtown",
    "https://picsum.photos/200/300?bridge",
];

const duration = 0.15
// FIX: Added `as const` to the `ease` property array to ensure it's inferred as a tuple, which is required by Framer Motion's `Transition` type.
const transition = { duration, ease: [0.32, 0.72, 0, 1] as const, filter: "blur(4px)" }
// FIX: Added `as const` to the `ease` property array to ensure it's inferred as a tuple, which is required by Framer Motion's `Transition` type.
const transitionOverlay = { duration: 2, ease: [0.32, 0.72, 0, 1] as const }
